    ...
    <body style="background-color: transparent; overflow: hidden" >
        <div class="allcontain container-fluid">
            <div class="feturedsection text-center">
                <h1 class="text-center" style="font-family: 'Roboto', serif; font-size: 40px; text-decoration: #000; margin-top: 25px; margin-bottom: 25px ">LISTADO DE ARMARIOS</h1>
            </div>
                            ...
                            <div class="table100-body js-pscroll">
                                <table>
                                    <tbody>
                                        ...
                                        $listaA = $tArmario->getAllArmarios();

                                        foreach ($listaA as $fila) {
                                            ?>
                                            <tr class="row100 body">
                                                <td class="cell100 column1"><?php echo $fila['cod_armario']; ?></td>
                                                <td class="cell100 column2"><?php echo $fila['modelo']; ?></td>
                                                <td class="cell100 column3"><?php echo $fila['nombre']; ?></td>
                                                <td class="cell100 column4">
                                                    <a class="elc-borrar" style="margin-left: -55px" href="deleteWardrobe.php?id=<?php echo $fila['id'] ?>">Borrar</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
